    ...
    <main class="mx-auto max-w-4xl flex justify-center items-center">
        <section class="backgroundContainer flex flex-col justify-center items-center">
            <div class="flex flex-col justify-center items-center">
                <img class="w-60 h-60 sm:w-40 sm:h-40 object-cover" src="img/pizza_g.png">
            ...
            <form method="post" onsubmit="return validateForm()"  id="prod1" class="flex justify-start p-4 flex-col" action="../Backend/produtoadd.php" enctype="Multipart/form-data">
                <!-- Preço Unitário -->
