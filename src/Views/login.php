    ...
    <main>
        <div id="div_form_login">
            ...
            <div id="return">
                ...
                <label class="login_inscrever"><a href="decisao.php" class="none_inscrever">Não tem uma conta? <B>Inscreva-se!</B></a></label>
                ...
                <div id="container_termos">
                    <label class="login_termos"><a href="privacidade.php" class="none_termos">Termos de privacidade</a></label>
                </div>
            </form>
        </div>
    </main>
