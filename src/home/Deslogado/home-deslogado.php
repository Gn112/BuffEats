...
<body class="min-h-screen bg-cinzafundo">
    ...
    <main class="container-md  ">
        ...
        <div class="mt-4 mb-4 d-flex justify-content-between">
            ...
            <button type="submit" onclick="<?php $codfiltro = 1; ?>" class="btn btn-light bg-white shadow p-2 ps-4 pe-4 text-danger-emphasis">Festa infantil</button>
            <button type="submit" onclick="<?php $codfiltro = 2; ?>" class="btn btn-light bg-white shadow p-2 ps-4 pe-4 text-danger-emphasis">Chá revelação</button>
            <button type="submit" onclick="<?php $codfiltro = 3; ?>" class="btn btn-light bg-white shadow p-2 ps-4 pe-4 text-danger-emphasis">Empresarial</button>
            <button type="submit" onclick="<?php $codfiltro = 4; ?>" class="btn btn-light bg-white shadow p-2 ps-4 pe-4 text-danger-emphasis">Festa familiar</button>
            <button type="submit" onclick="<?php $codfiltro = 5; ?>" class="btn btn-light bg-white shadow p-2 ps-4 pe-4 text-danger-emphasis">Bodas</button>
            <button type="submit" onclick="<?php $codfiltro = 6; ?>" class="btn btn-light bg-white shadow p-2 ps-4 pe-4 text-danger-emphasis">Aniversário</button>
